			...
			<div class="col-2 ">
				<a href='<c:url value="/" />'
					style="text-decoration: none; color: black">
					 <img alt="" src='<c:url value="/static/image/logoblue.png" />'
					 	width='100%' height='95%'
				...
				<sec:authorize access="isAuthenticated()">
					...
					<div class="dropdown" style="display: inline;">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
							<a class="dropdown-item" href="<c:url value="/user/thong-tin" />">Thông tin</a> <a
								class="dropdown-item" href="<c:url value="/logout" />">Đăng xuất</a> 
						</div>
					</div>
