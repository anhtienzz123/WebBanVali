...
<body>
				...
				<div id="danh-muc" class="col-4 bg-light">
					...
					<div class="card">
						...
						<ul class="list-group list-group-flush"
							...
							<li class="list-group-item">Thông tin tài khoản</li>
							...
							<fieldset class="form-group row">
								...
								<div class="col-sm-9 ">
									<div class="form-check-inline">
										<form:radiobutton path="gioiTinh" value="true" cssClass="form-check-input" id="nam"  />
										<label class="form-check-label" for="nam"> Nam </label>
									</div>
									<div class="form-check-inline">
										<form:radiobutton path="gioiTinh" value="false" cssClass="form-check-input" id="nu" />
	...
	<script type="text/javascript" src="${styleUrl }js/nguoiDung/nguoiDung.js"></script>
</body>
</html>